...
export default function LoginScreen() {
  ...
  return <AuthScreen>
    ...
    <Pressable accessibilityRole="link" onPress={() => router.push('/forgot-password')} style={styles.forgotLink}>
